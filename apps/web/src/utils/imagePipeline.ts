...
export function getDuotoneImageUrl(
  ...
  if (url.includes('cloudinary.com') && url.includes('/upload/')) {
    ...
    const duotoneTransform = 'e_grayscale,e_contrast:40,co_rgb:7cff3d,e_colorize:20,q_auto,f_auto/';
...
export const HERO_OVERLAY_GRADIENT = 
  'linear-gradient(to right, #111310 0%, rgba(17,19,16,0.85) 35%, rgba(17,19,16,0.4) 70%, rgba(124,255,61,0.08) 100%)';

export const CARD_DUOTONE_OVERLAY =
  'linear-gradient(to top, rgba(17,19,16,0.95) 0%, rgba(17,19,16,0.6) 50%, rgba(124,255,61,0.05) 100%)';
